module Api
  module V1
    class TemplatesController < BaseController
      ...
      def template_params
        template_params = params.permit(:terms, :name, :dealership_id, packages: [:id, :name, :terms, :absolute_mileage, coverages: %i[id length_in_months limit_in_miles caveat amount fee up_to ], addons: %i[id name amount fee, hide_numbers]])
